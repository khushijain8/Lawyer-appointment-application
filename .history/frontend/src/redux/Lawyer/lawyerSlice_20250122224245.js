            ...
            if (lawyer) {
              ...
              const newBookingHistory = [
                ...state.bookingHistory,
                {
                    ...
                    slotDate: lawyer.availability[slotIndex].date,
                    slotTime: lawyer.availability[slotIndex].time,
                    bookedAt: new Date().toISOString(), 
                }
            ];
            state.bookingHistory = newBookingHistory;
            }
...
export const { selectSlot } = lawyerSlice.actions;
