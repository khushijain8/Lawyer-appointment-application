      ...
      <div className="max-w-sm w-full lg:max-w-full lg:flex">
        ...
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">
            ...
            <div class="text-gray-900 font-bold text-xl mb-2">TechSys Solutions</div>
            <p class="text-gray-700 text-base">TechSys Solutions is a leading provider of enterprise software solutions that streamline business operations across various sectors. With a focus on data security and scalability, TechSys has built a reputation for delivering robust and customized software applications. Their flagship product, SysSecure, is widely adopted by financial institutions and healthcare organizations, providing real-time encryption and compliance management.</p>
          </div>
