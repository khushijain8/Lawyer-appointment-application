  ...
  return (
    ...
    <div className='root-div mx-10 ' >
      <div className="max-w-sm w-full lg:max-w-full lg:flex p-10">
        <div className="h-43 lg:h-auto lg:w-43 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={{ backgroundImage: `url(${tristar})` }}>
        </div>
      ...
      <div className="max-w-sm w-full lg:max-w-full lg:flex p-10">
        <div className="h-43 lg:h-auto lg:w-43 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow:hidden" style={{ backgroundImage: `url(${lexguard})` }}>
        </div>
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">
