      ...
      <div className="max-w-sm w-full lg:max-w-full lg:flex">
        ...
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">  
            ...
            <p class="text-gray-700 text-base">founded in 2010, has carved a niche in family law and real estate legal services. Known for its compassionate approach to sensitive matters, Firm B prides itself on providing personalized legal counsel to individuals facing complex family disputes or property-related issues. With an experienced team of legal professionals, the firm has earned a strong reputation for resolving disputes amicably while safeguarding the interests of its clients.</p>
          </div>
