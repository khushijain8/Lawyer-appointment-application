...
const lawyersData = [
  {
    ...
    availability: [
      ...
      { date: "2025-01-24", time: "11:00 to 11:30", isAvailable: true }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      { date: "2025-01-27", time: "13:00 to 13:30", isAvailable: true }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      { date: "2025-01-29", time: "17:00 to 17:30", isAvailable: true }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      { date: "2025-01-25", time: "10:30 to 11:00", isAvailable: true }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      { date: "2025-01-30", time: "09:30 to 10:00", isAvailable: true }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      { date: "2025-01-24", time: "13:00 to 13:30", isAvailable: true }
    ],
    costPerAppointment: 1500,
    bookingHistory:[],
  },
...
Lawyer_Firm2.insertMany(lawyersData)
  .then(docs => {
